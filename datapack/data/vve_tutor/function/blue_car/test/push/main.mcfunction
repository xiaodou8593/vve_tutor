#vve_tutor:blue_car/test/push/main
...
#function vve_tutor:blue_car/test/push/store_frame with storage vve_tutor:io {}

function vve_tutor:blue_car/main_c
scoreboard players set inp int 7500
execute if score test_n int matches 60..72 at @s positioned ~-1 ~0.5 ~ rotated -90.0 0.0 run function vve_tutor:blue_car/_poke_here_i_as
