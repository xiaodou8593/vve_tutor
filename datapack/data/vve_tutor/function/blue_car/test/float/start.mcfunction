#vve_tutor:blue_car/test/float/start
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_tutor:blue_car/test/float/main"
data modify storage marker_control:io result.del_func set value "vve_tutor:blue_car/test/float/end"
