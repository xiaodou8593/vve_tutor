#vve_tutor:blue_car/test/cp/main
...
#function vve_tutor:blue_car/test/cp/store_frame with storage vve_tutor:io {}
...
execute as 0-0-0-0-0 run function vve_tutor:blue_car/_iter_cpoints_render
# 运动同步
function vve_tutor:blue_car/_store
function vve_tutor:blue_car/main_sync
