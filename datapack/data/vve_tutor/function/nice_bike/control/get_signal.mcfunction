#vve_tutor:nice_bike/control/get_signal
# vve_tutor:nice_bike/control/main_c调用
...
execute on passengers run function vve_tutor:nice_bike/control/get_signal_true