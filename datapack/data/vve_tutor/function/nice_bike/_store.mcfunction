#vve_tutor:nice_bike/_store
# 临时对象赋值到实体对象
# 输入执行实体

scoreboard players operation @s stand_state = stand_state int
scoreboard players operation @s wheel_state = wheel_state int
scoreboard players operation @s control_active = control_active int
scoreboard players operation @s vve_euler_k = vve_euler_k int
scoreboard players operation @s vve_euler_b = vve_euler_b int
scoreboard players operation @s vve_euler_f = vve_euler_f int
scoreboard players operation @s vve_euler_max = vve_euler_max int
scoreboard players operation @s vve_euler_vmax = vve_euler_vmax int
scoreboard players operation @s target_theta = target_theta int
scoreboard players operation @s target_phi = target_phi int
scoreboard players operation @s target_psi = target_psi int
