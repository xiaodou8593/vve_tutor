#vve_tutor:nice_bike/_model
# 使用临时对象构建数据模板
# 输出数据模板storage vve_tutor:io result

data modify storage vve_tutor:io result set value {stand_state:0, wheel_state:0, control_active:0, damp_params:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d], target_euler:[0.0d, 0.0d, 0.0d], control:[0.0d, 0.0d, 0.0d], engine:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d], mass:0, tensor:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d], cube_shift_y:0, nvec:[0.0d, 0.0d, 0.0d], scale:[0.0d, 0.0d, 0.0d], center:[0.0d, 0.0d, 0.0d], velocity:[0.0d, 0.0d, 0.0d], angular_vec:[0.0d, 0.0d, 0.0d], angular_len:0, ivec:[0.0d, 0.0d, 0.0d], jvec:[0.0d, 0.0d, 0.0d], kvec:[0.0d, 0.0d, 0.0d], xyzw:[0.0d, 0.0d, 0.0d, 0.0d], start_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], orth_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], quat_phi:0}

execute store result storage vve_tutor:io result.stand_state int 1 run scoreboard players get stand_state int
execute store result storage vve_tutor:io result.wheel_state int 1 run scoreboard players get wheel_state int
execute store result storage vve_tutor:io result.control_active int 1 run scoreboard players get control_active int
execute store result storage vve_tutor:io result.damp_params[0] double 1 run scoreboard players get vve_euler_k int
execute store result storage vve_tutor:io result.damp_params[1] double 1 run scoreboard players get vve_euler_b int
execute store result storage vve_tutor:io result.damp_params[2] double 1 run scoreboard players get vve_euler_f int
execute store result storage vve_tutor:io result.damp_params[3] double 1 run scoreboard players get vve_euler_max int
execute store result storage vve_tutor:io result.damp_params[4] double 1 run scoreboard players get vve_euler_vmax int
execute store result storage vve_tutor:io result.target_euler[0] double 0.0001 run scoreboard players get target_theta int
execute store result storage vve_tutor:io result.target_euler[1] double 0.0001 run scoreboard players get target_phi int
execute store result storage vve_tutor:io result.target_euler[2] double 0.0001 run scoreboard players get target_psi int
