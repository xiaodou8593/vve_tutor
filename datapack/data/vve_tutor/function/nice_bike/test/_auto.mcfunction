#vve_tutor:nice_bike/test/_auto
# 自动化测试
# 以玩家为执行者
# 需要安装math3.1_gelib
...
data modify storage vve:io test_pointers set value [\
	"vve_tutor:nice_bike/test/cp/",\
	"vve_tutor:nice_bike/test/fall/",\
	"vve_tutor:nice_bike/test/push/",\
	"vve_tutor:nice_bike/test/float/",\
	"vve_tutor:nice_bike/test/inter_bounce/"\
]
