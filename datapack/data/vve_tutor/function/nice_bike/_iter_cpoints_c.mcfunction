#vve_tutor:nice_bike/_iter_cpoints_c
# 遍历八个顶点作为碰撞点，进行介质探测
# 输出介质响应(各模块的临时对象)
...
scoreboard players operation sstemp_jx int *= 3 int
scoreboard players operation sstemp_jy int *= 3 int
scoreboard players operation sstemp_jz int *= 3 int
...
scoreboard players operation sstemp_sx int *= 3 int
scoreboard players operation sstemp_sy int *= 3 int
scoreboard players operation sstemp_sz int *= 3 int
...
scoreboard players operation sstemp_ty int /= 2 int
scoreboard players operation sstemp_tz int /= 2 int
scoreboard players operation sstemp_jx int /= 10 int
scoreboard players operation sstemp_jy int /= 10 int
scoreboard players operation sstemp_jz int /= 10 int
scoreboard players operation sstemp_sx int /= 10 int
scoreboard players operation sstemp_sy int /= 10 int
scoreboard players operation sstemp_sz int /= 10 int
...
# 获取前进速度
scoreboard players operation temp_v int = vx int
scoreboard players operation temp_v int *= kvec_x int
scoreboard players operation stemp_0 int = vy int
scoreboard players operation stemp_0 int *= kvec_y int
scoreboard players operation temp_v int += stemp_0 int
scoreboard players operation stemp_0 int = vz int
scoreboard players operation stemp_0 int *= kvec_z int
scoreboard players operation temp_v int += stemp_0 int
scoreboard players operation temp_v int /= 10000 int

execute if score stand_state int matches 1 run function vve_tutor:nice_bike/iter_cpoints_7_8
